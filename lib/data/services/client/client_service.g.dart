...
class _ClientService implements ClientService {
  ...
  Future<List<ClientDto>> getClients() async {
    ...
    final _options = _setStreamType<List<ClientDto>>(
    ...
    late List<ClientDto> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => ClientDto.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<ClientDto> createClient({required ClientDto client}) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = client;
    final _options = _setStreamType<ClientDto>(
